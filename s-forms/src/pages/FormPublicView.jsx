...
export default function FormPublicView() {
    ...
    const handleSubmit = async () => {
        ...
        const payload = { form_slug, response: answer };

        try {
            const res = await fetch(`${apiurl}/forms/submit-response`, {
                method: "POST",
            ...
            console.error(err);
            alert("Error submitting response. Try again.");
        }
    };
        ...
        <div className="bg-black min-h-screen w-full flex flex-col items-center justify-center px-6 relative">
            <div className="w-full max-w-2xl mx-auto">
                ...
                <p className="text-gray-300 text-2xl mb-6 text-center">
                    {form?.questions?.[0]?.label || "Question not found"}
                </p>
